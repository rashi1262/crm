...
import EditBlogPage from './pages/EditBlogPage'; // <--- ADD THIS LINE

import DeleteBlogPage from './pages/DeleteBlogPage'; // ADD THIS IMPORT
            ...
            <Route element={<ProtectedRoute />}>
              ...
              <Route path="/" element={<Index />}>
               ...
               <Route path="allfollowup" element={<AllFollowUps />} />
                ...
                <Route path="blog/edit/:website/:id" element={<EditBlogPage />} /> {/* <--- ADD THIS LINE */}
                <Route path="blog/delete/:website/:id" element={<DeleteBlogPage />} /> {/* ADD THIS ROUTE */}
